        ...
        if (this.objectMouseOver != null && this.objectMouseOver.typeOfHit != RayTraceResult.Type.MISS)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (!EntityList.ENTITY_EGGS.containsKey(s))
                    {
                        return;
                    }
            ...
            if (itemstack.getItem() == null)
            {
                ...
                if (this.objectMouseOver.typeOfHit == RayTraceResult.Type.BLOCK)
                {
                    s1 = ((ResourceLocation)Block.REGISTRY.getNameForObject(this.theWorld.getBlockState(this.objectMouseOver.getBlockPos()).getBlock())).toString();
                }
